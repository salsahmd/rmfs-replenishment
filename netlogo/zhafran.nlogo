...
to setup
  ca
  let result ""
  py:setup "/Users/brendantm/Taiwan/TEEP/salsa-rmfs/netlogo/.venv/bin/python3"
  (py:run
    "import sys"
    "sys.path.insert(0, '/Users/brendantm/Taiwan/TEEP/salsa-rmfs/netlogo')"
    "import netlogo"
    "item = netlogo.setup()")
