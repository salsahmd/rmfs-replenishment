...
raw_file = root / "raw_order.csv"
sku_file = root / "sku_sample.csv"
dict_file = root / "items_dictionary.csv"
...
affinity_npz = root / "affinity_sparse.npz"
affinity_idx = root / "affinity_sku_index.csv"

if affinity_npz.exists() and affinity_idx.exists():
    A_mat = load_npz(str(affinity_npz))
    sku_index = pd.read_csv(affinity_idx)
    ...
    print("⚠️  Affinity files not found — skipping max_affinity (set to 0.0)")
    top_1000["max_affinity"] = 0.0
